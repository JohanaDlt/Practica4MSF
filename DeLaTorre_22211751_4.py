...
fg1.tight_layout()
fg1.savefig('sistema cardiovascular pyhton.png', dpi=600,bbox_inches='tight')
fg1.savefig('sistema cardiovascular pyhton.pdf')
...
plt.plot(t,Pp0,'-',linewidth=1,color=[0.93,0.64,0.35],label= 'Pp(t): Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=[0.23,0.67,0.20],label= 'Pp(t): Hipotenso')
plt.plot(t,Pp3,':',linewidth=3,color=[ 0.90,0.15,0.15],label= 'Pp(t): Hipotenso-PI')
plt.grid(False) #para que salga cuadricula
plt.xlim(0,10);plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4);plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
...
fg2.tight_layout()
fg2.savefig('sistema cardiovascular pyhton hipo PI.png', dpi=600,bbox_inches='tight')
fg2.savefig('sistema cardiovascular pyhton hipo PI.pdf')

fg3 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color=[0.93,0.64,0.35],label= 'Pp(t): Normotenso')
plt.plot(t,Pp2,'-',linewidth=1,color=[0.23,0.67,0.20],label= 'Pp(t): Hipertenso')
plt.plot(t,Pp4,':',linewidth=3,color=[ 0.90,0.15,0.15],label= 'Pp(t): Hipertenso-PI')
plt.grid(False) #para que salga cuadricula
plt.xlim(0,10);plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4);plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
...
fg3.tight_layout()
fg3.savefig('sistema cardiovascular pyhton hiper PI.png', dpi=600,bbox_inches='tight')
fg3.savefig('sistema cardiovascular pyhton hiper PI.pdf')
